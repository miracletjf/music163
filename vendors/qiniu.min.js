      ...
      n("moxie/core/utils/Basic", [], function () {
          ...
          return {
            ...
            atob: function (e, i) {
              ...
              var n, r, o, s, a, u, l, c, d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
                p = 0,
                f = 0,
                h = "",
                m = [];
          ...
          function c(o) {
            ...
            if (-1 !== e.inArray(e.typeOf(o), ["string", "node"]) && (o = {
                browse_button: o
              }), !(p = n.get(o.browse_button))) throw new r.DOMException(r.DOMException.NOT_FOUND_ERR);
            f = {
              accept: [{
          ...
          function f() {
            ...
            function u(t) {
              ...
              var a = this;
              w = (new Date).getTime(), b = new s, "string" == typeof z.required_caps && (z.required_caps = o.parseCaps(z.required_caps)), z.required_caps = e.extend({}, z.required_caps, {
            ...
            e.extend(this, S, {
              ...
              send: function (i, r) {
                if (z = "string" === e.typeOf(r) ? {
                    ruid: r
                  } : r || {}, this.readyState !== f.OPENED || N) throw new t.DOMException(t.DOMException.INVALID_STATE_ERR);
                if (i instanceof a) z.ruid = i.ruid, D = i.type || "application/octet-stream";
              ...
              abort: function () {
                if (k = !0, C = !1, ~e.inArray(i("readyState"), [f.UNSENT, f.OPENED, f.DONE])) i("readyState", f.UNSENT);
                else {
          ...
          function r() {
            ...
            i.call(this), e.extend(this, {
              ...
              transport: function (t, i, r) {
                ...
                if (r = e.extend({
                    chunk_size: 204798
                  }, r), (a = r.chunk_size % 3) && (r.chunk_size += 3 - a), p = r.chunk_size, n.call(this), l = t, c = t.length, "string" === e.typeOf(r) || r.ruid) o.call(s, i, this.connectRuntime(r));
                else {
                  var u = function (e, t) {
            ...
            t.extend(this, {
              send: function (i, r) {
                var a = this,
                  ...
                  m = !1;
                if (f = i.url.replace(/^.+?\/([\w\-\.]+)$/, "$1").toLowerCase(), p = l(), p.open(i.method, i.url, i.async, i.user, i.password), r instanceof o) r.isDetached() && (m = !0), r = r.getSource();
                else if (r instanceof s) {
                  if (r.hasBlob())
                    if (r.getBlob().isDetached()) r = d.call(a, r), m = !0;
                    else if ((c || h) && "blob" === t.typeOf(r.getBlob().getSource()) && window.FileReader) return void e.call(a, i, r);
                  if (r instanceof s) {
          ...
          return function i(n) {
            ...
            for (o = 2; o <= r.length();)
              if ((s = r.SHORT(o)) >= 65488 && s <= 65495) o += 2;
              else {
          ...
          return e.Image = t.extend({}, n, {
            getInfo: function () {
              ...
              return o.meta && (t.each(n, function (e) {
                ...
                if (a && a.keys)
                  for (r.meta[e] = {}, i = 0, n = a.keys.length; i < n; i++) t = a.keys[i], (s = a[t]) && (/^(\d|[1-9]\d+)$/.test(s) ? s = parseInt(s, 10) : /^\d*\.\d+$/.test(s) && (s = parseFloat(s)), r.meta[e][t] = s)
          ...
          function a() {
            function e() {
              var o, l, d, p, f, h, m = this,
                g = m.getRuntime();
              h = i.guid("uid_"), o = g.getShimContainer(), a && (d = n.get(a + "_form")) && i.extend(d.style, {
                top: "100%"
              }), p = document.createElement("form"), p.setAttribute("id", h + "_form"), p.setAttribute("method", "post"), p.setAttribute("enctype", "multipart/form-data"), p.setAttribute("encoding", "multipart/form-data"), i.extend(p.style, {
                overflow: "hidden",
                position: "absolute",
                top: 0,
                left: 0,
                ...
                if (this.value) {
                  ...
                  i = new t(g.uid, i), this.onchange = function () {}, e.call(m), m.files = [i], f.setAttribute("id", i.uid), p.setAttribute("id", i.uid + "_form"), m.trigger("change"), f = p = null
                }
            ...
            i.extend(this, {
              init: function (t) {
                var i, s = this,
                  a = s.getRuntime();
                u = t, c = t.accept.mimes || o.extList2mimes(t.accept, a.can("filter_by_extension")), i = a.getShimContainer(),
                  function () {
                    var e, o, c;
            ...
            t.extend(this, {
              send: function (d, p) {
                ...
                h.setAttribute("target", f + "_iframe"), p instanceof a && p.each(function (e, i) {
                    if (e instanceof s) m && m.setAttribute("name", i);
                    else {
      ...
      u.addFileFilter("mime_types", function (e, t, i) {
        ...
        function g(e, i, r) {
          function o(e, i, n) {
            ...
            switch (e) {
              ...
              case "filters":
                "array" === u.typeOf(i) && (i = {
                  mime_types: i
                }), n ? u.extend(T.filters, i) : T.filters = i, i.mime_types && ("string" === u.typeOf(i.mime_types) && (i.mime_types = t.core.utils.Mime.mimes2extList(i.mime_types)), i.mime_types.regexp = function (e) {
                  var t = [];
          ...
          "object" == typeof e ? u.each(e, function (e, t) {
            o(t, e, r)
          }) : o(e, i, r), r ? (T.required_features = n(u.extend({}, T)), C = n(u.extend({}, T, {
            required_features: !0
          }))) : l && (s.trigger("Destroy"), h.call(s, T, function (e) {
        ...
        function y(e) {
          if (e.state == u.STARTED) S = +new Date;
      ...
      this.resetUploadUrl = function (e) {
        ...
        for (var s = 0; s < o; s++) {
          var a = n.charCodeAt(s),
            u = null;
          if (a < 128) i++;
          else if (a > 127 && a < 2048) u = String.fromCharCode(a >> 6 | 192, 63 & a | 128);
          else if (63488 & a ^ !0) u = String.fromCharCode(a >> 12 | 224, a >> 6 & 63 | 128, 63 & a | 128);
          else {
        ...
        logger.debug("new plupload.Uploader(option)"), m.bind("Init", function (t, i) {
          ...
          if (u = u || t.settings && t.settings.chunk_size, logger.debug("uploader.runtime: ", m.runtime), logger.debug("chunk_size: ", u), "html5" !== m.runtime && "flash" !== m.runtime || !u) logger.debug("directUpload because uploader.runtime !== 'html5' || uploader.runtime !== 'flash' || !chunk_size"), s(t, i, that.key_handler);
          else if (i.size < u || a()) logger.debug("directUpload because file.size < chunk_size || is_android_weixin_or_qq()"), s(t, i, that.key_handler);
          else {
          ...
          s = s || e.settings && e.settings.chunk_size, o < s && (e.setOption({
        ...
        return m.bind("Error", function (t) {
          ...
          return function (i, n, r) {
            ...
            if (d = d || c.ctx, logger.debug("ctx: ", d), d) {
              ...
              var _, y = qiniuUploadUrl + "/mkfile/" + n.size + p + f + v,
          ...
          var n = new Date;
          if (!e.disable_statistics_report)
            for (var r = 0; r < i.length; r++) statisticsLogger.log(ExtraErrors.Cancelled, void 0, s(t.settings.url), void 0, a(t.settings.url), (n.getTime() - i[r]._start_at.getTime()) / 1e3, i[r]._start_at.getTime() / 1e3, i[r].size * i[r].percent / 100, "jssdk-" + t.runtime, i[r].size)
